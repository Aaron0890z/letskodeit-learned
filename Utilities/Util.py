...
from Utilities.GenericLogger import CustomLogger as cl
import logging
...
class Util(object):
    ...
    def getUniqueNameList(self, count, listSize=5):
        """
        ...
        for i in range(0, listSize):
            nameList.append(self.getUniqueName(count))
        return nameList
